                    ...
                    <div className="blog__table">
                        <div className="card mb-3 border-light blog__table__item">
                            ...
                            <div className="card-body">
                                <h5 className="card-title blog__table__title">Uncovering the Hidden Costs of Power
                                    Washing Your Home</h5>
                        ...
                        <div className="card mb-3 border-light blog__table__item">
                            ...
                            <div className="card-body">
                                <h5 className="card-title blog__table__title">How Much Does It Cost to Get Your House
                                    Power Washed? An Expert Guide</h5>
